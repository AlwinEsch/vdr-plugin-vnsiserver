...
bool cVNSIClient::processRECORDINGS_DELETED_GetCount() /* OPCODE 106 */
{
...
bool cVNSIClient::processRECORDINGS_DELETED_GetList() /* OPCODE 107 */
{
  cMutexLock lock(&m_timerLock);
  cThreadLock RecordingsLock(&Recordings);
...
bool cVNSIClient::processRECORDINGS_DELETED_Delete()
{
  cString recName;
  cRecording* recording = NULL;
...
bool cVNSIClient::processRECORDINGS_DELETED_Undelete()
{
...
bool cVNSIClient::processRECORDINGS_DELETED_DeleteAll()
{
  int ret = VNSI_RET_OK;
